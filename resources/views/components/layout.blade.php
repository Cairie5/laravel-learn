...
<body class="h-full">
    <!--
  This example requireschat updating your template:
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pt-4 pb-3">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Cairie Robot</div>
            <div class="text-sm font-medium text-gray-400">Cairie@pcairie.com</div>
          </div>
...
{{-- HOBBIES:physical, intellectual,creative,social --}}
